...
namespace Sneakerz
{
    public partial class Lanscape : Form
    {
        ...
        private void btnNike_Click(object sender, EventArgs e)
        {
            ...
            pic1.Image = Image.FromFile(pic1.ImageLocation = "../shoes/running/Nike/" + nike_running[0] + ".png");
            pic2.Image = Image.FromFile(pic2.ImageLocation = "../shoes/running/Nike/" + nike_running[1] + ".png");
            pic3.Image = Image.FromFile(pic3.ImageLocation = "../shoes/running/Nike/" + nike_running[2] + ".png");
            pic4.Image = Image.FromFile(pic4.ImageLocation = "../shoes/running/Nike/" + nike_running[3] + ".png");
            pic5.Image = Image.FromFile(pic5.ImageLocation = "../shoes/running/Nike/" + nike_running[4] + ".png");
            pic6.Image = Image.FromFile(pic6.ImageLocation = "../shoes/running/Nike/" + nike_running[5] + ".png");
            pic7.Image = Image.FromFile(pic7.ImageLocation = "../shoes/running/Nike/" + nike_running[6] + ".png");
            pic8.Image = Image.FromFile(pic8.ImageLocation = "../shoes/lifestyle/Nike/" + nike_lifestyle[0] + ".png");
            pic9.Image = Image.FromFile(pic9.ImageLocation = "../shoes/lifestyle/Nike/" + nike_lifestyle[1] + ".png");
            pic10.Image = Image.FromFile(pic10.ImageLocation = "../shoes/lifestyle/Nike/" + nike_lifestyle[2] + ".png");
            pic11.Image = Image.FromFile(pic11.ImageLocation = "../shoes/lifestyle/Nike/" + nike_lifestyle[3] + ".png");
            pic12.Image = Image.FromFile(pic12.ImageLocation = "../shoes/lifestyle/Nike/" + nike_lifestyle[4] + ".png");
            pic13.Image = Image.FromFile(pic13.ImageLocation = "../shoes/lifestyle/Nike/" + nike_lifestyle[5] + ".png");
            pic14.Image = Image.FromFile(pic14.ImageLocation = "../shoes/lifestyle/Nike/" + nike_lifestyle[6] + ".png");
            pic15.Image = Image.FromFile(pic15.ImageLocation = "../shoes/basketball/Nike/" + nike_basketball[0] + ".png");
            pic16.Image = Image.FromFile(pic16.ImageLocation = "../shoes/basketball/Nike/" + nike_basketball[1] + ".png");
            pic17.Image = Image.FromFile(pic17.ImageLocation = "../shoes/basketball/Nike/" + nike_basketball[2] + ".png");
            pic18.Image = Image.FromFile(pic18.ImageLocation = "../shoes/basketball/Nike/" + nike_basketball[3] + ".png");
            pic19.Image = Image.FromFile(pic19.ImageLocation = "../shoes/basketball/Nike/" + nike_basketball[4] + ".png");
            pic20.Image = Image.FromFile(pic20.ImageLocation = "../shoes/basketball/Nike/" + nike_basketball[5] + ".png");
            pic21.Image = Image.FromFile(pic21.ImageLocation = "../shoes/basketball/Nike/" + nike_basketball[6] + ".png");
            ...
            txtName1.Text = nike_running[0];
            txtName2.Text = nike_running[1];
            txtName3.Text = nike_running[2];
            txtName4.Text = nike_running[3];
            txtName5.Text = nike_running[4];
            txtName6.Text = nike_running[5];
            txtName7.Text = nike_running[6];
            txtName8.Text = nike_lifestyle[0];
            txtName9.Text = nike_lifestyle[1];
            txtName10.Text = nike_lifestyle[2];
            txtName11.Text = nike_lifestyle[3];
            txtName12.Text = nike_lifestyle[4];
            txtName13.Text = nike_lifestyle[5];
            txtName14.Text = nike_lifestyle[6];
            txtName15.Text = nike_basketball[0];
            txtName16.Text = nike_basketball[1];
            txtName17.Text = nike_basketball[2];
            txtName18.Text = nike_basketball[3];
            txtName19.Text = nike_basketball[4];
            txtName20.Text = nike_basketball[5];
            txtName21.Text = nike_basketball[6];
        }
        ...
        private void btnAdidas_Click(object sender, EventArgs e)
        {
            ...
            pic1.Image = Image.FromFile(pic1.ImageLocation = "../shoes/running/Adidas/" + adidas_running[0] + ".png");
            pic2.Image = Image.FromFile(pic2.ImageLocation = "../shoes/running/Adidas/" + adidas_running[1] + ".png");
            pic3.Image = Image.FromFile(pic3.ImageLocation = "../shoes/running/Adidas/" + adidas_running[2] + ".png");
            pic4.Image = Image.FromFile(pic4.ImageLocation = "../shoes/running/Adidas/" + adidas_running[3] + ".png");
            pic5.Image = Image.FromFile(pic5.ImageLocation = "../shoes/running/Adidas/" + adidas_running[4] + ".png");
            pic6.Image = Image.FromFile(pic6.ImageLocation = "../shoes/running/Adidas/" + adidas_running[5] + ".png");
            pic7.Image = Image.FromFile(pic7.ImageLocation = "../shoes/running/Adidas/" + adidas_running[6] + ".png");
            pic8.Image = Image.FromFile(pic8.ImageLocation = "../shoes/lifestyle/Adidas/" + adidas_lifestyle[0] + ".png");
            pic9.Image = Image.FromFile(pic9.ImageLocation = "../shoes/lifestyle/Adidas/" + adidas_lifestyle[1] + ".png");
            pic10.Image = Image.FromFile(pic10.ImageLocation = "../shoes/lifestyle/Adidas/" + adidas_lifestyle[2] + ".png");
            pic11.Image = Image.FromFile(pic11.ImageLocation = "../shoes/lifestyle/Adidas/" + adidas_lifestyle[3] + ".png");
            pic12.Image = Image.FromFile(pic12.ImageLocation = "../shoes/lifestyle/Adidas/" + adidas_lifestyle[4] + ".png");
            pic13.Image = Image.FromFile(pic13.ImageLocation = "../shoes/lifestyle/Adidas/" + adidas_lifestyle[5] + ".png");
            pic14.Image = Image.FromFile(pic14.ImageLocation = "../shoes/lifestyle/Adidas/" + adidas_lifestyle[6] + ".png");
            pic15.Image = Image.FromFile(pic15.ImageLocation = "../shoes/basketball/Adidas/" + adidas_basketball[0] + ".png");
            pic16.Image = Image.FromFile(pic16.ImageLocation = "../shoes/basketball/Adidas/" + adidas_basketball[1] + ".png");
            pic17.Image = Image.FromFile(pic17.ImageLocation = "../shoes/basketball/Adidas/" + adidas_basketball[2] + ".png");
            pic18.Image = Image.FromFile(pic18.ImageLocation = "../shoes/basketball/Adidas/" + adidas_basketball[3] + ".png");
            pic19.Image = Image.FromFile(pic19.ImageLocation = "../shoes/basketball/Adidas/" + adidas_basketball[4] + ".png");
            pic20.Image = Image.FromFile(pic20.ImageLocation = "../shoes/basketball/Adidas/" + adidas_basketball[5] + ".png");
            pic21.Image = Image.FromFile(pic21.ImageLocation = "../shoes/basketball/Adidas/" + adidas_basketball[6] + ".png");
            ...
            txtName1.Text = adidas_running[0];
            txtName2.Text = adidas_running[1];
            txtName3.Text = adidas_running[2];
            txtName4.Text = adidas_running[3];
            txtName5.Text = adidas_running[4];
            txtName6.Text = adidas_running[5];
            txtName7.Text = adidas_running[6];
            txtName8.Text = adidas_lifestyle[0];
            txtName9.Text = adidas_lifestyle[1];
            txtName10.Text = adidas_lifestyle[2];
            txtName11.Text = adidas_lifestyle[3];
            txtName12.Text = adidas_lifestyle[4];
            txtName13.Text = adidas_lifestyle[5];
            txtName14.Text = adidas_lifestyle[6];
            txtName15.Text = adidas_basketball[0];
            txtName16.Text = adidas_basketball[1];
            txtName17.Text = adidas_basketball[2];
            txtName18.Text = adidas_basketball[3];
            txtName19.Text = adidas_basketball[4];
            txtName20.Text = adidas_basketball[5];
            txtName21.Text = adidas_basketball[6];
        }
